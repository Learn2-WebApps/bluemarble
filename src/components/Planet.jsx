...
export default function Planet({ color, isLocked, width = 80, height = 80 }) {
  ...
  return (
    <svg width={width} height={height} viewBox="0 0 100 100" style={{ overflow: 'visible', filter: isLocked ? 'grayscale(80%) opacity(0.5)' : 'none' }}>
      ...
      <path d="M 10 70 A 45 15 -20 0 1 90 30" fill="none" stroke="rgba(255,255,255,0.6)" strokeWidth="6" strokeLinecap="round" />
      <circle cx="50" cy="50" r="30" fill={isRainbow ? 'url(#rainbow-grad)' : color} />
      <path d="M 90 30 A 45 15 -20 0 1 10 70" fill="none" stroke="rgba(255,255,255,0.9)" strokeWidth="6" strokeLinecap="round" />
      {isLocked && (
